...
\chapter{Datapath}
		...
		% 		\item Ler o conteúdo de um ou dois registos(depende da instrução a executar);
		% 	\end{enumerate}
		%
		% 	Depois destes dois passos iniciais dependendo do tipo de instrução a executar os dados vão seguir caminhos diferenntes.Dentro do mesmo tipo de instruções os elementos a usar não variam muito, tornando mais fácil a implementação do Datapath.
		%
